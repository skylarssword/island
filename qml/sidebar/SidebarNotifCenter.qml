        ...
        Item {
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    readonly property real dismissThreshold: -52
                    readonly property real maxSwipe:         -84

                    // Explicit animations so we can attach onFinished
                    NumberAnimation {
                        id: snapBack
                        target: notifRow; property: "dragX"
                        to: 0; duration: 240; easing.type: Easing.OutQuart
                    }
                    NumberAnimation {
                        id: slideOff
                        target: notifRow; property: "dragX"
                        to: -(notifList.width + 20); duration: 220; easing.type: Easing.InCubic
                        onFinished: root.dismissRequested(notifRow.entry.id)
                    }
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onPressed: function(mouse) {
                                snapBack.stop(); slideOff.stop()
                                pressX = mouse.x; hasMoved = false
                                notifRow.isDragging = true
                            }
