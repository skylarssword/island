 ...
 Rectangle {
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            color: lrclibErrorText !== "" ? StyleTokens.error : StyleTokens.textMuted
                            font.pixelSize: 10
                            font.family: textFontFamily
                            font.weight: Font.Medium
                            elide: Text.ElideRight
                        ...
                        Text {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            text: "›"
                            color: lrclibPanelOpen ? "#c7c9cf" : StyleTokens.textSubtle
                            font.pixelSize: 17
                            font.family: textFontFamily
                            font.weight: Font.DemiBold
                        }
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            color: fileErrorText !== "" ? StyleTokens.error :
                                   (fileInfoText !== "" ? StyleTokens.success : StyleTokens.textMuted)
                            font.pixelSize: 10
                            font.family: textFontFamily
                            font.weight: Font.Medium
                            elide: Text.ElideRight
                        ...
                        Text {
                            ...
                            anchors.verticalCenter: parent.verticalCenter
                            text: "›"
                            color: localFilePanelOpen ? "#c7c9cf" : StyleTokens.textSubtle
                            font.pixelSize: 17
                            font.family: textFontFamily
                            font.weight: Font.DemiBold
                        }
                            ...
                            delegate: Rectangle {
                                ...
                                Row {
                                    ...
                                    Rectangle {
                                        ...
                                        radius: 8
                                        anchors.verticalCenter: parent.verticalCenter
                                        color: modelData.hasSynced ? StyleTokens.success : StyleTokens.textSubtle
                                        opacity: 0.85
