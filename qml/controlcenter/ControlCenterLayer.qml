...
Row {
                ...
                Rectangle {
                    ...
                    Text {
                        ...
                        color: controlCenter.hyprsunsetActive
                               ? "#e5a84b"
                               : (sunsetBtnMouse.containsMouse ? Qt.rgba(1,1,1,0.9) : StyleTokens.textPrimary)
                        Behavior on color { ColorAnimation { duration: 150 } }
                    }
...
Rectangle {
                ...
                Item {
                    ...
                    Text {
                        ...
                        font.family: iconFontFamily
                        font.pixelSize: 18
                        color: controlCenter.gamemodeActive ? "#60a5fa" : StyleTokens.textDisabled
